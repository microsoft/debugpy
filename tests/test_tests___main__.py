...
class ConvertArgsTests(unittest.TestCase):
    ...
    def test_no_args(self):
        argv, runtests, lint = convert_argv([])
    ...
    def test_discovery_full(self):
        argv, runtests, lint = convert_argv(['-v', '--failfast', '--full'])
    ...
    def test_discovery_quick(self):
        argv, runtests, lint = convert_argv(['-v', '--failfast', '--quick'])
    ...
    def test_modules(self):
        argv, runtests, lint = convert_argv(['-v', '--failfast',
                             'w',
    ...
    def test_lint(self):
        argv, runtests, lint = convert_argv(['-v', '--quick', '--lint'])
    ...
    def test_lint_only(self):
        argv, runtests, lint = convert_argv(['--quick', '--lint-only', '-v'])
    ...
    def test_coverage(self):
        argv, runtests, lint = convert_argv(['--coverage'])
